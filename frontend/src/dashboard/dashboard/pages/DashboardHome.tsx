...
import WelcomeHeader from "@/dashboard/dashboard/components/WelcomeHeader";
import AllProjects from "@/dashboard/dashboard/components/AllProjects";
import ProjectsPanelMobile from "@/dashboard/dashboard/components/ProjectsPanelMobile";
import NotificationsPage from "@/dashboard/dashboard/components/NotificationsPage";
import Messages from "@/dashboard/messages";
import Settings from "@/dashboard/dashboard/components/Settings";
import Collaborators from "@/dashboard/dashboard/components/Collaborators";
import SpinnerScreen from "@/shared/ui/SpinnerScreen";
import PendingApprovalScreen from "@/shared/ui/PendingApprovalScreen";
import AllProjectsWeekWidget from "@/dashboard/dashboard/components/AllProjectsWeekWidget";
import WeekWidgetDesktop, { type Track, type Dot } from "@/dashboard/dashboard/components/WeekWidgetDesktop";
import TasksOverviewCard from "@/dashboard/dashboard/components/TasksOverviewCard";
import MobileTasksOverviewCard from "@/dashboard/dashboard/components/MobileTasksOverviewCard";
import NavigationDrawer from "@/shared/ui/NavigationDrawer";
import DashboardNavPanel from "@/shared/ui/DashboardNavPanel";
import ProjectsPanelDesktop from "@/dashboard/dashboard/components/ProjectsPanelDesktop";
