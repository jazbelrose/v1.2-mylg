...
const CalendarOverviewCard: React.FC<CalendarOverviewCardProps> = ({
  ...
  const overlayHeaderId = useMemo(
    () => (overlayDayKey ? `calendar-overview-card-day-${overlayDayKey}` : "calendar-overview-card-day"),
    [overlayDayKey]
  );
  ...
  return (
    <div
      className={`dashboard-item calendar-overview-card-wrapper${wrapperHover ? " calendar-card-hover" : ""}`}
